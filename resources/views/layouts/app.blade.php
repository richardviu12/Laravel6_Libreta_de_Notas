...
<body class="hold-transition  sidebar-mini layout-fixed">
    <div id="app">
        <div class="wrapper">
            ...
            <!-- Navbar -->
            <nav class="main-header navbar navbar-expand navbar-dark navbar-lightblue"> <!-- aquí puedo cambiar el color del header-->
                <!-- Left navbar links -->
                <ul class="navbar-nav">
                    <li class="nav-item">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{ asset('dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                        style="opacity: .8">  <!-- La función ASSET permite que lareval lea la ruta url para que se vea el logo en todas las paginas -->
                    <span class="brand-text font-weight-light">Samalá-POS</span>
                </a>
            ...
            <footer class="main-footer">
               <strong>Copyright &copy; 2020 <a href="http://eureka.click"> Ing. Ricardo A. Villagrán</a>.</strong>
               All rights reserved.
